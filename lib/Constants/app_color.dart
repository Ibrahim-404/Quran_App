...
class AppColor {
  //light theme
  static const Color LightprimaryColor = Color(0xFF242424);
  static const Color lightscondaryColor = Color(0xFFB7935F);
  static const Color lightthirdColor = Color(0xFFB7935F);
